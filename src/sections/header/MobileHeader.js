...
const MobileHeader = () => {
    ...
    return(
        <section className="sm:hidden block relative">
            ...
            <nav className={`${toggleMenu ? "translate-x-0" : "-translate-x-60"} w-60 bg-blue-500 flex flex-col justify-center text-white absolute h-screen top-10 z-50 transition duration-700`}>
